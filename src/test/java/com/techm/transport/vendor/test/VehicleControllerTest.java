...
import com.techm.transport.vendor.service.VehicleVerificationService;
	...
	@WebMvcTest(value=com.techm.transport.vendor.test.VehicleControllerTest.class)	
	...
	public class VehicleControllerTest {
	   ...
	   @Autowired
		...
		Sample sam=new Sample("KA-123456", "11", "10", "not-valid");
		...
		public void getVehicleByName() throws Exception
		{
			...
			Mockito.when(service.getVecbyName(Mockito.anyString())).thenReturn(sam); 
			
			
              MockHttpServletResponse result= mockMvc.perform(get("/1.0/vec/KA-1234").accept(MediaType.APPLICATION_JSON)).andReturn().getResponse();	
